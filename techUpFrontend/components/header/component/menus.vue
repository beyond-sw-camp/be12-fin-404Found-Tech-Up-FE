<template>
  <ul>
    <li v-for="(item, i) in menu_data" :key="i"
      :class="`${item.drop_down ? 'has-dropdown' : item.mega_menu ? 'has-dropdown has-mega-menu' : ''}`">
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
            <div class="shop-mega-menu-img">
              ...
              <div class="shop-mega-menu-btn">
                <nuxt-link href="/shop?category=mobile-tablets"
                  class="tp-menu-showcase-btn tp-menu-showcase-btn-2">Phones
                </nuxt-link>
              </div>
            </div>
          </div>
          <div class="col-lg-3">
            <div class="shop-mega-menu-img">
              ...
              <div class="shop-mega-menu-btn">
                <nuxt-link href="/shop?category=headphones"
                  class="tp-menu-showcase-btn tp-menu-showcase-btn-2">Headphones</nuxt-link>
              </div>
            </div>
          </div>
        </div>
