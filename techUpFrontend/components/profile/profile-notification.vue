<template>
  <div class="profile__notification">
    <div class="profile__notification-top mb-30">
      ...
      <p>Stay up to date with notification on activity that involves you including mentions, messages, replies to your
        bids, new items, sale and administrative updates </p>
    </div>
